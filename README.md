...
## Getting started
1. Download Redshift Tray from the [releases page](https://github.com/ltGuillaume/Redshift-Tray/releases) and extract it to a folder you really like. Alternatively, you can [install via Chocolatey](https://chocolatey.org/packages/rstray) (thx [tunisiano187](https://github.com/tunisiano187)) or [install via Scoop](https://scoop.sh) (thx [Ash258](https://github.com/Ash258)).
